...
/usr/bin/cmake ../  -DBUILD_EXAMPLES=true -DCMAKE_BUILD_TYPE=release -DFORCE_RSUSB_BACKEND=false -DBUILD_WITH_CUDA=true -DCMAKE_CUDA_COMPILER=/usr/local/cuda/bin/nvcc -DBUILD_PYTHON_BINDINGS=bool:true
