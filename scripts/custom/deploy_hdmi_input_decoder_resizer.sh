...
default_config_path="/home/$USER/dev/orx/data/experiment_config/datahub_01/hdmi_input_0"
...
docker run --rm -it --gpus all --runtime=nvidia \
    ...
    vschorp98/orx-middleware-isaac-ros-"$PLATFORM_NAME"-hdmi_input_decoder_resizer