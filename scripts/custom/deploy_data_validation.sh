...
DOCKER_IMAGE_NAME=vschorp98/orx-middleware-isaac-ros-"$PLATFORM_NAME"-data_validation
echo "Running: $DOCKER_IMAGE_NAME with user $DOCKER_USER"

docker_name="data_validation"
...
docker run --rm -it --gpus all --runtime=nvidia \
    ...
    -v /home/"$USER"/dev/orx/data_validation_config:/home/"$DOCKER_USER"/config \
    --user $DOCKER_USER \
