...
default_config_path="/home/$USER/dev/orx/data/experiment_config/datahub_09/intel_realsense_d435_0"
...
docker_name=$(basename ${config_path})_decoder_resizer
...
docker run --rm -it --gpus all --runtime=nvidia \
    ...
    girf/orx-middleware-isaac-ros-"$PLATFORM_NAME"-realsense_d435_decoder_resizer