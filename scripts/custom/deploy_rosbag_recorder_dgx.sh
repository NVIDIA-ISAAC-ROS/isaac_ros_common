...
sudo docker run --rm -it --gpus all --runtime=nvidia \
    ...
    -v /home/adm_girf/dev/orx/rosbag_recorder_config/config.yaml:/home/admin/config/config.yaml \
    vschorp98/orx-middleware-isaac-ros-"$PLATFORM_NAME"-rosbag_recorder \